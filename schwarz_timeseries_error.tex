...
\begin{equation}
    ...
    \text{,}
\end{equation}
so that the open and closed forms are expressed in the same terms,
\begin{align}
    ...
    \text{,}
\end{align}
thereby removing the need for superscripts ($o$ and $c$) in the notation.
...
\begin{align}
    m^c(t_{k-1}, y_{s-1}) &=  \delta_{k-1}e_{k-1,s-1} \text{,} \notag \\
    m^c(t_{k-1}, y_{s})   &=  \delta_{k-1}e_{k-1,s} \text{,} \notag \\
