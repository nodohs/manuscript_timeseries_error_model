...
\begin{abstract}
    ...
    Consequently, operators must periodically check, clean, and recalibrate the measurement device.
    By modeling the error growth between these checks as a stochastic process,
    we derive bias corrections and confidence intervals for the measured time-series.
\end{abstract}
...
caused by fouling and calibration drift,
as well as irreducible measurement noise.
