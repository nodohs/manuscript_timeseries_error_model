...
\begin{abstract}
    ...
    yields closed-form estimates of the expected error and its uncertainty,
...
and may involve cleaning or recalibrating the measurement device,
which resets the error to zero.

We can represent the fouling and calibration-drift as
continuous-time stochastic processes that evolve gradually between checks.
% Conditioning these processes on the check measurements yields simple
...
correspond to the Kalman filtering and smoothing solutions for this system.

The framework extends naturally to multi-point calibration procedures,
as well as to networks of multiple measurement devices with shared parameters.
