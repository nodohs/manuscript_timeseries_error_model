...
that arise from fouling, calibration drift, 
and the inherent precision of the device.
...
After a clean, and calibrated device is deployed into an environment,
fouling and calibration-drift begin to accumulate that
...
Our proposed error model is equivalent to a linear Gaussian state-space model,
